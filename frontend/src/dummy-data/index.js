...
export const CONVERSATIONS = [
  {
    ...
    initials: "PS",
    preview: "Yes, the proposal looks great — can we hop on a quick call?",
    time: "2m",
    unread: 2,
    channel: "WhatsApp",
    status: "Unread",
  ...
  },
  {
    ...
    company: "Northwind",
    initials: "DC",
    preview: "Thanks Maya. I'll loop in our procurement team this week.",
    time: "14m",
    unread: 0,
    channel: "Email",
    status: "Open",
  ...
  },
  {
    ...
    company: "Atelier Rossi",
    initials: "SR",
    preview: "Could you share the integration docs again? 🙏",
    time: "38m",
    unread: 1,
    channel: "Instagram",
    status: "Unread",
  ...
  },
  {
    ...
    company: "Kairos Labs",
    initials: "AT",
    preview: "Our team just finished onboarding — first impressions are great.",
    time: "1h",
    unread: 0,
    channel: "Email",
    status: "Assigned",
  ...
  {
    id: "c5",
    customer: "Lila Okafor",
    company: "Bloom & Co",
    initials: "LO",
    preview: "Pricing is a bit higher than expected — any flexibility?",
    time: "3h",
    unread: 0,
    channel: "WhatsApp",
    status: "Open",
  ...
  },
  {
    ...
    company: "Solare Group",
    initials: "MB",
    preview: "Closed — they signed with a competitor. Logging notes.",
    time: "1d",
    unread: 0,
    channel: "Email",
    status: "Closed",
  ...
  },
  {
    ...
    company: "Mira Foods",
    initials: "HP",
    preview: "Booking the demo for next Tuesday at 11am IST.",
    time: "1d",
    unread: 0,
    channel: "SMS",
    status: "Open",
  ...
  },
  {
    ...
    company: "Vela Travel",
    initials: "DA",
    preview: "Reactivation campaign reply — interested in Q2 plans.",
    time: "2d",
    unread: 0,
    channel: "Facebook",
    status: "Assigned",
...
export const CONVERSATION_THREAD = [
  { id: "m1", from: "customer", text: "Hi Maya — got the deck, thanks for sharing!", time: "10:14 AM" },
  { id: "m2", from: "agent", text: "Hi Priya, your visit is confirmed. Can we lock Thursday 11am?", time: "10:00 AM", isAutoSent: true, journey: "Visit Reminder" },
  { id: "m3", from: "customer", text: "Yes — and I'd love to see the analytics module live.", time: "10:18 AM" },
  { id: "m4", from: "agent", text: "Perfect. Sharing a Loom in 5 minutes covering both.", time: "10:19 AM" },
  { id: "m5", from: "customer", text: "Yes, the proposal looks great — can we hop on a quick call?", time: "10:42 AM" },
  { id: "m6", from: "agent", text: "Following up on the proposal — happy to walk you through pricing tiers today.", time: "10:44 AM", isAutoSent: true, journey: "Proposal Follow-up" },
  { id: "m7", from: "ai", text: "Suggested reply: \"Absolutely — I have a slot today at 3:00 PM IST. Does that work?\"", time: "10:45 AM" },
];

export const QUICK_REPLIES = [
  "Sounds great — let me check.",
  "Sharing the deck now.",
